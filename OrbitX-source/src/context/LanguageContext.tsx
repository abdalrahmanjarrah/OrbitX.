...
const dictionary: Record<string, Record<string, string>> = {
  en: {
    ...
    "onboarding.identity_sub": "Your journey begins now at Level 1 and 0 XP. Prepare to rise through levels and collections!",
    ...
    "home.hour_unit": "hrs",
    "home.space_rank": "Astronaut Level",
