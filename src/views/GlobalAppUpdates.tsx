...
export default function GlobalAppUpdates() {
  ...
  return (
    <AnimatePresence>
      <div className="fixed inset-0 z-[999999] flex items-center justify-center p-4" id="updates-modal-overlay">
        ...
        <motion.div
          ...
          className="relative max-w-lg w-full p-6 rounded-2xl border border-fuchsia-500/40 bg-[#040615]/95 backdrop-blur-2xl shadow-[0_20px_50px_rgba(236,72,153,0.25),_inset_0_1px_2px_rgba(255,255,255,0.1)] overflow-hidden text-right flex flex-col z-[1000000]"
