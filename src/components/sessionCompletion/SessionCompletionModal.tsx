    ...
    <AnimatePresence>
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4" id="session-completion-overlay-container">
        ...
        <motion.div
          ...
          className="relative max-w-lg w-full p-6 rounded-2xl border border-white/10 bg-[#030616]/95 backdrop-blur-2xl shadow-[0_20px_50px_rgba(0,0,0,0.8),_inset_0_1px_1px_rgba(255,255,255,0.05)] overflow-hidden text-right z-20 flex flex-col"
